<x-app-layout>
    <div class="md:py-4" x-data="{ day: 1, price: {{$product->price}} }"
        x-init="$watch('day', () => { day < 1 ? day = 1 : null })">
                    ...
                    <div class="static md:sticky top-5 space-y-3">
                        <x-card class="w-full space-y-2" addClass="p-5">
                            ...
                            <div class="flex flex-col justify-center space-y-1">
                                <span class="text-3xl font-bold" x-mask="99/99">@money($product->price)</span>
                                {{--<span class="text-3xl font-bold" x-money.id-ID.IDR.decimal="day*price"></span>
                                <span class="text-3xl font-bold" x-mask="99/99">1231</span>
                                <input type="text" name="" id="" x-mask="Rp 99/99" disabled value="1212">--}}
                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="flex space-x-2">
                                    <x-primary-button class="flex justify-center w-12" addClass="p-0"
                                        @click="day != 1 && day--">
                                    ...
                                    <input type="number"
                                        ...
                                        x-model="day">
                                    <x-primary-button class="flex justify-center w-12" addClass="p-0" @click="day++">
                                        <span class="font-extrabold text-3xl">+</span>
                                    </x-primary-button>
                                </div>
                            </div>
                            <div class="flex flex-col">
                                ...
                                <select name="size" id="size"
                                    class="rounded-lg focus:ring-0 focus:border-indigo-600 w-40">
